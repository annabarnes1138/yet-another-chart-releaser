...
func init() {
	...
	flags.StringP("index-path", "i", ".yacr-index/index.yaml", "Path to index file")
	flags.StringP("package-path", "p", ".yacr-release-packages", "Path to directory with chart packages")
